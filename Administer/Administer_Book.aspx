<%@ Page Title="" Language="C#" MasterPageFile="~/Administer/Administer.master" AutoEventWireup="true" CodeFile="Administer_Book.aspx.cs" Inherits="Administer_Administer_Book" %>
...
<div class="content">
                    ...
                    <div class="data-fluid" align="right">
                            ...
                            <div class="data-fluid">
                                  <asp:GridView ID="GridView1" runat="server" cellpadding="0" width="100%" 
                                    class="table table-hover" AutoGenerateColumns="False" DataKeyNames="BookID"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="测试">
                                            ...
                                            <ItemTemplate>
                                               ...
                                               <input id="HiddenSysCode" runat="server" style="width: 193px" type="hidden" value='<%# Eval("BookID")%>' /><!--这行很重要，它在一个隐藏控件里放置了一个字段的值，该字段的值将会在按钮事件处理CheckBox选中项的操作中用到-->
                                        ...
                                        <asp:HyperLinkField DataNavigateUrlFields="BookID" 
                                                 ...
                                                 DataTextField="Title" HeaderText="书籍名称"> 
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="class1"/>
                                        </asp:HyperLinkField>
                                        ...
                                        <asp:BoundField DataField="Name" HeaderText="推荐者" 
                                            SortExpression="Name">
                                        <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="class1" />
                                        </asp:BoundField>
                                        ...
                                        <asp:TemplateField ShowHeader="False">
                                             <ItemTemplate>  
                                                <asp:Button ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Del"  
                                                       Text="删除" CssClass="btn btn-success" CommandArgument= '<%#Eval("BookID")%>'></asp:Button>  
                                                </ItemTemplate>  
                                             <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="class1"/>
                                        </asp:TemplateField>
                                        <asp:TemplateField ShowHeader="False">
                                             <ItemTemplate>  
                                                <asp:Button ID="LinkButton2" runat="server" CausesValidation="False" CommandName="Scan"  
                                                       Text="查看书籍" CssClass="btn" CommandArgument= '<%#Eval("BookID")%>'></asp:Button>  
                                                </ItemTemplate>  
                                             <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" CssClass="class1"/>
                                        </asp:TemplateField>
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
           ...
           SelectCommand="SELECT * FROM [User],[Book] WHERE [Book].[UserID] = [User].[UserID]">
        </asp:SqlDataSource>
                            </div> 
