...
public partial class Administer_Administer_Comment : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "Del")
        {
            ...
            {
                var user = db.BookReview.SingleOrDefault<BookReview>(s => s.BookReviewID == id);
                if (user != null)
                {
                    db.BookReview.DeleteOnSubmit(user);
                    db.SubmitChanges();
                }
            }
        ...
        {
            Response.Redirect("../BookWareHouse/CheckBookReview.aspx?BookReviewID="+e.CommandArgument.ToString());
        }
    }
