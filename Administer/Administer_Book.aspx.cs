...
public partial class Administer_Administer_Book : System.Web.UI.Page
{
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        else if (e.CommandName == "Del")
        {
            ...
            {
                var book = db.Book.SingleOrDefault<Book>(s => s.BookID == id);
                if (book != null)
                {
        ...
        else if (e.CommandName == "Scan")
        {
            ...
            Response.Redirect("../BookWareHouse/CheckBook.aspx?BookID=" + e.CommandArgument.ToString());
        }
    }
